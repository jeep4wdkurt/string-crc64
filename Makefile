# This Makefile is for the String::CRC64 extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[String-CRC64]
#     LICENSE => q[restricted]
#     META_MERGE => { resources=>{ bugtracker=>q[https://github.com/jeep4wdkurt/string-crc64/issues], homepage=>q[https://github.com/jeep4wdkurt/string-crc64], license=>q[https://github.com/jeep4wdkurt/string-crc64/blob/master/LICENSE], repository=>q[https://github.com/jeep4wdkurt/string-crc64] } }
#     NAME => q[String::CRC64]
#     OBJECT => q[CRC64.o]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[CRC64.pm]
...
# These definitions are from config.sh (via /usr/lib/perl5/5.26/x86_64-cygwin-threads/Config.pm).
...
PERL_LIB = /usr/share/perl5/5.26
PERL_ARCHLIB = /usr/lib/perl5/5.26/x86_64-cygwin-threads
PERL_ARCHLIBDEP = /usr/lib/perl5/5.26/x86_64-cygwin-threads
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /usr/lib/perl5/5.26/x86_64-cygwin-threads/CORE
PERL_INCDEP = /usr/lib/perl5/5.26/x86_64-cygwin-threads/CORE
...
MAKEMAKER   = /usr/share/perl5/5.26/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.24
MM_REVISION = 72400
...
MAKE = make
FULLEXT = String/CRC64
BASEEXT = CRC64
PARENT_NAME = String
DLBASE = $(BASEEXT)
VERSION_FROM = CRC64.pm
OBJECT = CRC64$(OBJ_EXT)
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
# Extra linker info
EXPORT_LIST        = 
PERL_ARCHIVE       = $(PERL_INC)/cygperl5_26.dll
PERL_ARCHIVEDEP    = 
PERL_ARCHIVE_AFTER = 
...
XSUBPPDIR = /usr/share/perl5/5.26/ExtUtils
XSUBPP = "$(XSUBPPDIR)$(DFSEP)xsubpp"
XSUBPPRUN = $(PERLRUN) $(XSUBPP)
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl5/5.26/ExtUtils/typemap typemap /usr/share/perl5/5.26/ExtUtils$(DFSEP)xsubpp
XSUBPPARGS = -typemap '/usr/share/perl5/5.26/ExtUtils/typemap' -typemap '/cygdrive/d/zcygwin/home/booger/fksperl/string-crc64/typemap'
XSUBPP_EXTRA_ARGS =
...
# String::CRC64 might depend on some other libraries:
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  CRC64.pod $(INST_MAN3DIR)/String.CRC64.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(LIB_EXT) *$(OBJ_EXT) \
	  *perl.core CRC64.base \
	  CRC64.bs CRC64.bso \
	  CRC64.c CRC64.def \
	  CRC64.exp CRC64.o \
	  CRC64_def.old MYMETA.json \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: String-CRC64' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'resources:' >> META_new.yml
	$(NOECHO) $(ECHO) '  bugtracker: https://github.com/jeep4wdkurt/string-crc64/issues' >> META_new.yml
	$(NOECHO) $(ECHO) '  homepage: https://github.com/jeep4wdkurt/string-crc64' >> META_new.yml
	$(NOECHO) $(ECHO) '  license: https://github.com/jeep4wdkurt/string-crc64/blob/master/LICENSE' >> META_new.yml
	$(NOECHO) $(ECHO) '  repository: https://github.com/jeep4wdkurt/string-crc64' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "String-CRC64",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "web" : "https://github.com/jeep4wdkurt/string-crc64/issues"' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	$(NOECHO) $(ECHO) '      "homepage" : "https://github.com/jeep4wdkurt/string-crc64",' >> META_new.json
	$(NOECHO) $(ECHO) '      "license" : [' >> META_new.json
	$(NOECHO) $(ECHO) '         "https://github.com/jeep4wdkurt/string-crc64/blob/master/LICENSE"' >> META_new.json
	$(NOECHO) $(ECHO) '      ],' >> META_new.json
	$(NOECHO) $(ECHO) '      "repository" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "url" : "https://github.com/jeep4wdkurt/string-crc64"' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
MAP_TARGET    = perl
FULLPERL      = "/usr/bin/perl.exe"
MAP_PERLINC   = "-Iblib/arch" "-Iblib/lib" "-I/usr/lib/perl5/5.26/x86_64-cygwin-threads" "-I/usr/share/perl5/5.26"
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="String-CRC64" VERSION="1">' > String-CRC64.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> String-CRC64.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> String-CRC64.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> String-CRC64.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-cygwin-threads-multi-5.26" />' >> String-CRC64.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> String-CRC64.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> String-CRC64.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> String-CRC64.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'CRC64.pm' '$(INST_LIB)/String/CRC64.pm' \
	  'CRC64.pod' '$(INST_LIB)/String/CRC64.pod' 
